...
function getHandler(options, proxy, requestMiddleware) {
  var corsAnywhere = {
  ...
  return function(req, res) {
    ...
    let middlewareResponse = requestMiddleware({ req, res })
    req = middlewareResponse.req
    res = middlewareResponse.res
...
exports.createServer = function createServer(options, requestMiddleware = ({ req,res })=>({ req, res })) {
  options = options || {};
  ...
  var requestHandler = getHandler(options, proxy, requestMiddleware);
  var server;
